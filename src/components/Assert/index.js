        ...
        <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
          ...
          <TableCell>
            <IconButton
              ...
              size="small"
              onClick={() => { alert('create launch assert ' + row.name) }}
            >
              <AddIcon />
            </IconButton>
            <IconButton
              aria-label="Delete"
              size="small"
              onClick={() => { alert('delete assert ' + row.name) }}
            >
              <DeleteIcon />
            </IconButton>
          </TableCell>
                      ...
                      <TableRow key={historyRow.date}>
                        ...
                        <TableCell align="right">
                          <IconButton
                            aria-label="Delete"
                            size="small"
                            onClick={() => { alert('delete launch ' + historyRow.valor) }}
                          >
                            <DeleteIcon />
                          </IconButton>
                        </TableCell>
